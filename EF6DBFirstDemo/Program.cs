    ...
    internal class Program
    {
        ...
        public static void ExecuteRawSQLusingSqlQuery()
        {
            ...
            using (var context = new SchoolDBEntities())
            {
                ...
                var student = context.Students.SqlQuery(
                    "SELECT StudentId, StudentName, StandardId, RowVersion " + 
                    "FROM Student WHERE StudentId = 1").ToList();
            }
        ...
        public static void ExecuteSqlCommand()
        {
            ...
            using (var context = new SchoolDBEntities())
            {
                ...
                //Update command
                int noOfRowUpdate = context.Database.ExecuteSqlCommand(
                    "UPDATE student SET studentname ='Mark' WHERE studentname = 'Robert'");
