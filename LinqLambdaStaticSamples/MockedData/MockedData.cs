...
namespace LinqLambdaStaticSamples.MockedData
{
    public static class MockedData
    {
        public static (List<Product> ProductList, List<Customer> CustomerList) CreateLists()
        {
            ...
            return (productList, customerList);
        }
    }
}
